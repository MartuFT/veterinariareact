                ...
                >
                  ...
                  <label htmlFor="fileTransversal" className={`dropzone-label ${fileTransversal ? 'hidden' : ''}`}>
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7 18a4 4 0 0 1 0-8c.2 0 .4 0 .6.1A5 5 0 0 1 17 7a4 4 0 0 1 1 7.9V15a3 3 0 0 1-3 3H7z" stroke="#4d5bf9" strokeWidth="1.5" fill="none"/>
                      <path d="M12 12v6M9.5 14.5H14.5" stroke="#4d5bf9" strokeWidth="1.5" strokeLinecap="round"/>
                    </svg>
